...
|------------|-------------------------------------------------|--------|----------|
| Tue Jan 9  | Introduction to Course                          | [Slides]() |  |
<!-- | Thu Jan 11 | Convex sets, functions                          | [Slides]() |  |
| Tue Jan 16 | Unconstrained optimization, gradient descent    | [Slides]() | HW 1 |
| Thu Jan 18 | Newton's method                                 | [Slides]() |  |
| Tue Jan 23 | Simple applications of optimization models      | [Slides]() | HW 2 |
| Thu Jan 25 | Modeling using pyomo                            | [Slides]() |  |
