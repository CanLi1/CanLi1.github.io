...
![]({{ site.url }}{{ site.baseurl }}/images/respic/extremeweather.png){: style="width:50%; align: center; margin: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/multiscale.png){: style="width:60%; align: center; margin: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/hardware.png){: style="width:50%; align: center; margin: 10px"}
